...
namespace RunGroup.Controllers
{
    public class DashboardController : Controller
    {
        ...
        private void MapUserEdit(AppUser user, EditUserDashboardViewodel editVM, ImageUploadResult photoResult)
        {
            user.Id = editVM.Id;
        ...
        public async Task<IActionResult> EditUserprofile()
        {
            ...
            var editUserViewModel = new EditUserDashboardViewodel()
            {
                Id = curUserId,
                Pace = user.Pace,
                Milage = user.Milage,
        ...
        [HttpPost]
        public async Task<IActionResult> EditUserprofile(EditUserDashboardViewodel editVM)
        {
